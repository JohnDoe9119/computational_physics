# -*- coding: utf-8 -*-
"""
Created on Thu Oct 13 06:18:58 2022
...
W = 200; WeightBox = 400                    #Weight of table and box
...
suport2 = cone(pos=vector(d,0,0), axis = vector(0,Hsupport, 0),
               color=color.yellow, radius = 20)
...
arrowFl = arrow(color=color.red,
                pos=vector(-d,Hsupport+thickness/2,0), axis =vector(0,0.15*Fl,0))
...
for t in arange(0.0,65.0,.5):
    rate(10)
    x=-d+v*t
    cube.pos = vector(x, Hsupport+Hbox/2+10,0)  #positioncube
